 ...
 * Pi Cloak
 *
 * Redacts configured secrets from matching file reads before their contents are
 * returned to the model, while leaving the files unchanged on disk. This is
 * useful for inspecting configuration safely without leaking tokens, passwords,
 * or other sensitive values into model context and persisted session history.
 */
