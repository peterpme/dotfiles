...
6. For a big or wide change, run it as an `arena`. Ask several independent configured roles the same question and merge the answers. Independent passes catch different real bugs.
