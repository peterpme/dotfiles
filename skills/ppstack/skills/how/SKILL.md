...
The parent synthesizes. Do not spawn a second “explainer” child unless the explorer dumps cannot fit in this window. Read `references/explainer-prompt.md` for voice. Reconcile overlaps, resolve contradictions, weave one picture.
