...
1. **Done predicate.** Countable or falsifiable, in words a script could check. A duration is not a predicate. "Work on this for four hours" buys four hours of motion.
...
6. **Budgets.** Councils, scouts, and reviewers cap at 10 minutes. Workers get a brief-sized cap. Name the whole-run budget and stop spawning at roughly 70 percent of it to land what is verified. Two retries per unit, then abandon and replan.
...
8. **Trail.** The `decisions.tsv` path per **show-me-your-work**, committed or local. Snags go to **log-problems**.
