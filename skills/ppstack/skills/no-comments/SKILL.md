...
1. Spawn Comment Sicko. Pi: `agent: "comment-sicko"`. Cursor: `subagent_type: "Comment Sicko"`. Pass the scope. Do not restate its rules. Read `../petey/references/spawn.md`.
