...
The Pi parent runs **how** and **why**. Delegate only their scoped leaf investigations, which may run in parallel with no-edits briefs. Do not load either coordinator workflow in a helper.
