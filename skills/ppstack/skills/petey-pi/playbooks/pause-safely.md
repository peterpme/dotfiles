...
1. Stop at a safe boundary. Finish the current atomic step or back out of it. Never stop mid-edit in a known-broken state. Start nothing new. Inspect active Herdr helpers, ask them to stop writes at a safe boundary, and confirm they have stopped. A wait timeout does not cancel them.
