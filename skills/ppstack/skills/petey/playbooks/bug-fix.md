...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to the configured `worker` with a specific scope; review the diff. Do not select a model per run.
