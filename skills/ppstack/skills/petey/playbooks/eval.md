...
4. **Spawn N parallel candidates** through the configured roles per the **arena** skill's Phase B, without per-run model selection. Each works in its own sanitized dir; same prompt to each.
